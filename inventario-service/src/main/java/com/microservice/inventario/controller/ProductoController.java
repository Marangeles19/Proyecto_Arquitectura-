...
//        return new ResponseEntity<>(service.findAll(), HttpStatus.OK);
    ...
    @GetMapping("/search-detall/{idProdcut}")
    public ResponseEntity<?> findDetallByProducto(@PathVariable Integer idProdcut){
        return ResponseEntity.ok(service.findDetallByIdProduct(idProdcut));
}
